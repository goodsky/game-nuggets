// Customized from Unity's Standard-FirstPass terrain shader source (5.6.1)
// See MIT License from archive. https://unity3d.com/get-unity/download/archive

Shader "Custom/Terrain/Grid" {
	Properties {
	...
	SubShader {
		...
		#include "Custom-TerrainSplatmapCommon.cginc"
	...
	Dependency "AddPassShader" = "Hidden/Custom/Terrain/Grid-AddPass"
