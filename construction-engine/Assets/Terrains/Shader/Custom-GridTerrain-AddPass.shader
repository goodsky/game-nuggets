// Customized from Unity's Standard-AddPass terrain shader source (5.6.1)
// See MIT License from archive. https://unity3d.com/get-unity/download/archive

Shader "Hidden/Custom/Terrain/Grid-AddPass" {
	Properties {
	...
	SubShader {
		...
		//#include "Custom-TerrainSplatmapCommon.cginc" The custom shader doesn't understand added passes
